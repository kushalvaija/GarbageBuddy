...
<body>
        ...
        <div class="header-content">
            ...
            <nav class="nav-links">
                <?php if(isset($_SESSION['user_email'])): ?>
                    ...
                    <a href="logout.php" style="color: var(--secondary-color);">LOGOUT</a>
                <?php else: ?>
                    ...
                    <a href="signup.php" style="color: var(--secondary-color);">SIGN UP</a>
                <?php endif; ?>
            </nav>
        </div>
    </header>
    ...
    <!-- Success Message Container -->
    <div id="successMessage" class="success-message-container" style="display: none;">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('.floating-bg').classList.add('loaded');
            document.querySelectorAll('.floating-circle').forEach(circle => {
                circle.classList.add('loaded');
            });
            document.querySelector('.header').classList.add('loaded');
            document.querySelector('.hero').classList.add('loaded');
            document.querySelector('.camera-btn').classList.add('loaded');
            AOS.init({
                duration: 800,
                once: true,
                offset: 100,
